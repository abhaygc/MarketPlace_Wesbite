...
<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['placeorder']))
  {
    ...
    /************************************   PLACING ORDER *********************************************/
      ...
      {
                  $id = $_SESSION['cartitems'][0];
                  $sql ="select name,cid,image,description,price,unit from products where id='".$id."'";
                  ...
                  $sql2 = "INSERT INTO orders (order_id,product_id,cid,product_name,quantity,user_id,status,i_price,unit,total_price,order_date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
         
        if($stmt = mysqli_prepare($link, $sql2))
        {
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssssssssss", $param_orderid, $param_pid,$param_cid,$param_pname,$param_quantity,$param_userid,$param_status,$param_price,$param_unit,$param_total,$param_order_date);
      ...
      else
      {
              foreach ($cartitems as $key => $id) 
              {
                  ...
                  $order_id=uniqid();
                  $today = date("d/m/Y");
                  $sql2 = "INSERT INTO orders (order_id,product_id,cid,product_name,quantity,user_id,status,i_price,unit,total_price,profit,total_profit,order_date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)";
         
        if($stmt = mysqli_prepare($link, $sql2))
        {
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssssssssssss", $param_orderid, $param_pid,$param_cid,$param_pname,$param_quantity,$param_userid,$param_status,$param_price,$param_unit,$param_total,$param_profit,$param_total_profit,$param_order_date);
        ...
        /**********************************/
          ...
          /************HEADLINE********************************/
              ...
              if ($_SESSION['cart_count' ]==1) 
              {
                  ...
                  echo '<img class="img-thumbnail" src="'.$image_link.'" alt="Card image cap" style="margin-top:2em;height:10em;width:10em;">';
                  echo "</div>";
              ...
              foreach ($cartitems as $key => $id) 
              {
                  ...
                  echo "<div class='col-2 h-100 justify-content-center align-items-center d-flex font-weight-bold'>";
                    echo "<div class='clear'></div>";
                    echo "<span style='font-size:1em'>₹ </span><span class='totalAmount' id='".$id."_total' style='font-size:1.5em'>".$row['price']*$_POST['quantity'][$key]."</span>";
                  echo "</div>";
...
/****************************************************FOOTER TOTAL PRICE******************************************************************/
			echo "<div class='row w-100 mx-auto content-fluid' style='border-bottom-style:solid;border-bottom-color:black;padding-left:1em;padding-right:1em;'>";
                  ...
                  echo "<div class='col-2 justify-content-center align-items-center d-flex'>";
                          ...
                          echo "<span class='align-middle font-weight-bold'></span>";
                  echo "</div>";
                  echo "<div class='col-2  justify-content-center align-items-center d-flex'>";
                  ...
                  echo "<div class='col-2  justify-content-center align-items-center d-flex font-weight-bold' style='font-size:1em'>";
                    echo "Total";
                    echo "<div class='row' style='margin-top:2em;margin-left:-1.5em;font-size:1.5em'>";
