<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST")
  {
    $today = date("d/m/Y");
        ...
        $sql = "INSERT INTO cfeedback (fid,user_id,name,email,phone_number,description,date_added,status) VALUES (?,?,?, ?, ?, ?,?,?)";
         
        if($stmt = mysqli_prepare($link, $sql))
        {
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssssss", $param_fid,$param_uid,$param_name,$param_email,$param_phone,$param_message,$param_date,$param_status);
...
<nav class="navbar navbar-expand-md  fixed-top navbar-light header" style="background-color: white;border-bottom-style: solid;border-bottom-color: rgba(0,0,0,.5);border-bottom-width: 1px;font-size: 1em;height: 3.125emem;padding-top: 12px;padding-bottom: 12px" >
    <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link py-0" href="#" style="font-weight: 600;letter-spacing: 1px;"><span style="color: #b06010;">Feedback</span></a>
            </li>
...
<!-- contact -->
  <div class="container-fluid w-100 mx-auto" id="contact" style="margin-top: 2em;">
    <h3 class="text-center mx-auto">Feedback Form</h3>
    <p class="text-center mx-auto">To Give Feedback About Our Services Please Contact Us Directly Or Fill The Form Below</p>
    <div class="container">
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="w3_ip" style="margin-top: 2em;">
