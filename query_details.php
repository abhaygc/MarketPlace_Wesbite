    ...
    <div class="col-md-2 position-fixed dashboard-menu bg-dark" style="min-height: 100%;" >
  	...
  	<div class="col-10 offset-2 dashboard-content" style="margin-top: 40px;">
       ...
       ?>
  		...
  		<div class="container-fluid w-100" style="padding-left: 5em;margin-top: 3em;">
  			...
  			<div class="row w-100 mx-auto">
	  			<div class="col">
	  				...
	  				<div class="row w-100">
	  					<div class="col-9">
	  						<input style="font-size: 1.5em" class="form-control" value='<?php echo $row['qid']; ?>'  disabled/>
	  					</div>
	  				</div>
  			...
  			<div class="row w-100 mx-auto">
	  			<div class="col">
	  				...
	  				<div class="row w-100">
	  					<div class="col-8">
	  						<span style="font-size: 1.5em">Subject</span>
	  					</div>
	  				</div>
	  				<div class="row w-100">
	  					<div class="col-10">
	  						<input style="font-size: 1.5em" class="form-control" value='<?php echo $row['subject']; ?>'  disabled/>
	  					</div>
	  				</div>
  		...
  		<?php
  				$sql = 'UPDATE query SET status="VIEWED" WHERE qid="'.$id.'"';
  				$result = mysqli_query($link,$sql);
