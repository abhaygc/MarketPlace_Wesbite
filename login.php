...
<div class="content">
	<div class="login-details">
		<form name="LogForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="application/x-www-form-urlencoded">
			<span style="display:block;text-align:center;font-size: 25px;margin-top: 5px;">Login</span><br/>
			<div class="email">
			...
			<div class="create-account">
				Don't have account? <a id="create-acc" href="register.php">Create Now.</a>
			</div>
			<div clear="both"></div>
			<div class="submit">
